...
window.onload = function () {
	...
	if (document.getElementsByTagName("EN-UK").length == 1) {
		logoURL = document.getElementsByTagName("EN-UK")[0].innerHTML.split("logo: '").pop().split("'").shift();
