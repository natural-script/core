...
function changePage(pageName) {
    $('#' + decodeURIComponent(getAllUrlParams().page) + '').fadeOut(500);
    $('#' + pageName + '').fadeIn(500);
            ...
            return this.each(function () {
                ...
                $.fn[tooltipTranslations[lang]] = function (options) {
                    ...
                    var settings = $.extend({
                        ...
                        [directionTranslations[lang]]: fromTheBottomTranslations[lang],
                        [animationTranslations[lang]]: null,
                        [backgroundTranslations[lang]]: null,
                        [transparencyTranslations[lang]]: null,
                        [containerTranslations[lang]]: null,
                    ...
                    return this.each(function () {
                        var name = settings[nameTranslations[lang]];
                        var out = '<div id="' + name + '_container"><paper-tooltip id="' + name + '" for="' + settings[emitterTranslations[lang]] + '">' + settings[textTranslations[lang]] + '</paper-tooltip></div>';
                        if (settings[containerTranslations[lang]]) {
                            $('#' + settings[containerTranslations[lang]] + '').append(out);
                        } else {
                            $('contents').append(out);
