...
window.attributesTranslations = ['attributes', 'attributes', "attributs", 'الصفات', 'الصفات', '属性'];
...
window.dropdownMenuTranslations = ['dropdown_menu', 'dropdown_menu', "menu_déroulant", 'قائمة_منسدلة', 'قائمة_منسدلة', 'ドロップダウンメニュー'];
...
window.clonedElementTranslations = ['cloned_element', 'cloned_element', "élément_clone", 'العنصر_المستنسخ', 'العنصر_المستنسخ', 'クローンされた要素'];