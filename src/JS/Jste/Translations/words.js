...
window.transparentTranslations = ['transparent', 'transparent', 'transparence', 'شفافة', 'شفافة', '透明性'];
...
window.dropdownMenuTranslations = ['dropdown_menu', 'dropdown_menu', "une couleur sombre aléatoire", 'لون غامق عشوائى', 'لون غامق عشوائى', 'ランダムな暗い色'];