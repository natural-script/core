...
import { MemorySessionManager } from "./sessions";
import JSObjectHandler from "./lang/javascript";
...
const codeAnalyzer = (function() {
	...
	**DEPRECATED**
	...
	```
	*/
	codeAnalyzer.prototype.Promise = Promise;
